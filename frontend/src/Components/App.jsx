...
function App() {
  ...
  const fetchSmarts = async () => {
    try {
      const response = await axios.get('http://10.16.3.66:8081/smartdevices');
  ...
  const fetchCubicGates = async () => {
    try {
      const response = await axios.get('http://10.16.3.66:8081/gates');
      setData(response.data);
  ...
  const fetchDataTable = async () => {
    try {
      const response = await axios.get('http://10.16.3.66:8081/data');
      setData(response.data);
      setshowSmart(false); // Hide Smarts table when showing Gates
  ...
  const fetchEveryNlc = async () => {
    try {
      const response = await axios.get('http://10.16.3.66:8081/everynlc');
      setData(response.data);
      setshowSmart(false); // Hide Smarts table when showing Gates
      setShowCubicGates(false);
      setShowDataTable(false);
  ...
  const fetchInboundaryStations = async () => {
    try {
      const response = await axios.get('http://10.16.3.66:8081/inboundarystations');
      setData(response.data);
      setshowSmart(false); // Hide Smarts table when showing Gates
      setShowCubicGates(false);
      setShowDataTable(false);
  ...
  const fetchLocationData = async () => {
    try {
      const response = await axios.get('http://10.16.3.66:8081/locationdata');
      setData(response.data);
      setshowSmart(false); // Hide Smarts table when showing Gates
      setShowCubicGates(false);
      setShowDataTable(false);
  ...
  const fetchSnbGates = async () => {
    try {
      const response = await axios.get('http://10.16.3.66:8081/snbgates');
      setData(response.data);
      setshowSmart(false); // Hide Smarts table when showing Gates
      setShowCubicGates(false);
      setShowDataTable(false);
  ...
  const fetchSnbPvals = async () => {
    try {
      const response = await axios.get('http://10.16.3.66:8081/snbpvals');
      setData(response.data);
      setshowSmart(false); // Hide Smarts table when showing Gates
      setShowCubicGates(false);
      setShowDataTable(false);
  ...
  const fetchStations = async () => {
    try {
      const response = await axios.get('http://10.16.3.66:8081/stations');
      setData(response.data);
      setshowSmart(false); // Hide Smarts table when showing Gates
      setShowCubicGates(false);
      setShowDataTable(false);
  ...
  const fetchVixPvals = async () => {
    try {
      const response = await axios.get('http://10.16.3.66:8081/vixpvals');
      setData(response.data);
      setshowSmart(false); // Hide Smarts table when showing Gates
      setShowCubicGates(false);
      setShowDataTable(false);
